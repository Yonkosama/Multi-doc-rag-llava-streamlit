...
# NOTE: Persist the Chroma DB so that content survives app reloads, aiding debugging and consistency.
# Old (in-memory, non-persistent) initialization kept for reference:
